    ...
    <section className="min-h-screen flex items-center justify-center px-6 pt-20">
      <div className="max-w-3xl text-center">
        ...
        <p className="text-base text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
          ...
          I'm specializing in AI, Computer Vision, and Applied Mathematics. My
          current coursework includes Deep Learning, Generative Models, 3D/Video
          Vision, Object Recognition, NLP, Signal Processing, and ML
